...
![](../../pic/2019-09-08-21-34-16.png)

其中Mark Word在默认情况下存储着对象的HashCode、分代年龄、锁标记位等以下是32位JVM的Mark Word默认存储结构

![](../../pic/2019-09-08-21-35-19.png)

由于对象头的信息是与对象自身定义的数据没有关系的额外存储成本，因此考虑到JVM的空间效率，Mark Word 被设计成为一个非固定的数据结构，以便存储更多有效的数据，它会根据对象本身的状态复用自己的存储空间，如32位JVM下，除了上述列出的Mark Word默认存储结构外，还有如下可能变化的结构：

![](../../pic/2019-09-08-21-34-58.png)

对象头的MarkWord
![对象头的MarkWord](../../pic/2019-09-08-22-18-10.png)

偏向锁的获取和释放流程
![偏向锁的获取和释放流程](../../pic/2019-09-08-22-14-53.png)

![](../../pic/2019-09-08-22-33-01.png)

偏向锁转化为轻量级锁的过程
![偏向锁转化为轻量级锁的过程](../../pic/2019-09-08-22-36-33.png)

![](../../pic/2019-09-08-22-41-35.png)

无锁状态变为轻量级锁的过程
![无锁状态变为轻量级锁的过程](../../pic/2019-09-08-22-27-30.png)

![](../../pic/2019-09-08-22-30-59.png)

轻量级锁变为重量级锁的过程
![轻量级锁变为重量级锁的过程](../../pic/2019-09-08-22-19-58.png)
