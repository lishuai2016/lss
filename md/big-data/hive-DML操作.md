...
- [1、Hive 常用DML操作](#1hive-常用dml操作)
    - [1、加载文件数据到表](#1加载文件数据到表)
        - [1.1 语法](#11-语法)
        - [1.2 示例](#12-示例)
    - [2、查询结果插入到表](#2查询结果插入到表)
        - [2.1 语法](#21-语法)
        - [2.2 动态插入分区](#22-动态插入分区)
        - [2.3 示例](#23-示例)
    - [3、使用SQL语句插入值](#3使用sql语句插入值)
    - [4、更新和删除数据](#4更新和删除数据)
        - [4.1 语法](#41-语法)
        - [4.2 示例](#42-示例)
    - [5、查询结果写出到文件系统](#5查询结果写出到文件系统)
        - [5.1 语法](#51-语法)
        - [5.2 示例](#52-示例)
- [2、其他](#2其他)
- [参考资料](#参考资料)
...
![](../../pic/2021-03-21/2021-03-21-17-11-38.png)
...
2、、一般按照分区插入数据的时候会先把该分区的数据删除

删掉分区，清理掉数据

alter table temp1 drop partition(dt = '20190601');

hadoop fs -rm -r /user/temp1/dt=20190601   删除这个temp1表分区dt=20190601

insert overwrite table temp1 partition
(dt = '20190601')
SELECT column1 ，column2 from temp2 
