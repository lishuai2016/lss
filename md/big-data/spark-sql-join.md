...
- [Spark SQL JOIN](#spark-sql-join)
    ...
    - [二、连接类型](#二连接类型)
        ...
        - [2.2 FULL OUTER JOIN](#22-full-outer-join)
        - [2.3 LEFT OUTER JOIN](#23-left-outer-join)
        - [2.4 RIGHT OUTER JOIN](#24-right-outer-join)
        - [2.5 LEFT SEMI JOIN](#25-left-semi-join)
        - [2.6 LEFT ANTI JOIN](#26-left-anti-join)
        - [2.7 CROSS JOIN](#27-cross-join)
        - [2.8 NATURAL JOIN](#28-natural-join)
    - [三、连接的执行](#三连接的执行)
    - [参考资料](#参考资料)
...
<div align="center"> <img src="../../pic/sql-join.jpg"/> </div>
...
<div align="center"> <img src="../../pic/spark-sql-NATURAL-JOIN.png"/> </div>
...
<div align="center"> <img width="600px" src="../../pic/spark-Big-table–to–big-table.png"/> </div>
...
<div align="center"> <img  width="600px" src="../../pic/spark-Big-table–to–small-table.png"/> </div>
