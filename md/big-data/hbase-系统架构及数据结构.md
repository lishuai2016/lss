...
- [1、基本概念](#1基本概念)
    - [1.1 Row Key (行键)](#11-row-key-行键)
    - [1.2 Column Family（列族）](#12-column-family列族)
    - [1.3 Column Qualifier (列限定符)](#13-column-qualifier-列限定符)
    - [1.4 Column(列)](#14-column列)
    - [1.5 Cell](#15-cell)
    - [1.6 Timestamp(时间戳)](#16-timestamp时间戳)
- [2、存储结构](#2存储结构)
    - [2.1 Regions](#21-regions)
    - [2.2 Region Server](#22-region-server)
- [3、Hbase系统架构](#3hbase系统架构)
    - [3.1 系统架构](#31-系统架构)
    - [3.2 组件间的协作](#32-组件间的协作)
- [4、数据的读写流程简述](#4数据的读写流程简述)
    - [4.1 写入数据的流程](#41-写入数据的流程)
    - [4.2 读取数据的流程](#42-读取数据的流程)
- [参考资料](#参考资料)
...
![](../../pic/2021-03-21/2021-03-21-22-05-14.png)
...
![](../../pic/2021-03-21/2021-03-21-22-12-27.png)
...
![](../../pic/2021-03-21/2021-03-21-22-13-21.png)
...
![](../../pic/2021-03-21/2021-03-21-22-15-55.png)
...
![](../../pic/2021-03-21/2021-03-21-22-17-06.png)
...
![](../../pic/2021-03-21/2021-03-21-22-18-46.png)
