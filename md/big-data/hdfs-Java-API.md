...
- [HDFS Java API](#hdfs-java-api)
    ...
    - [二、API的使用](#二api的使用)
        ...
        - [2.2 创建目录](#22-创建目录)
        - [2.3 创建指定权限的目录](#23-创建指定权限的目录)
        - [2.4 创建文件，并写入内容](#24-创建文件并写入内容)
        - [2.5 判断文件是否存在](#25-判断文件是否存在)
        - [2.6 查看文件内容](#26-查看文件内容)
        - [2.7 文件重命名](#27-文件重命名)
        - [2.8 删除目录或文件](#28-删除目录或文件)
        - [2.9 上传文件到HDFS](#29-上传文件到hdfs)
        - [2.10 上传大文件并显示上传进度](#210-上传大文件并显示上传进度)
        - [2.11 从HDFS上下载文件](#211-从hdfs上下载文件)
        - [2.12 查看指定目录下所有文件的信息](#212-查看指定目录下所有文件的信息)
        - [2.13 递归查看指定目录下所有文件的信息](#213-递归查看指定目录下所有文件的信息)
        - [2.14 查看文件的块信息](#214-查看文件的块信息)
