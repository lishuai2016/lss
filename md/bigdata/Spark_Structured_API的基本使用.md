...
- [Structured API基本使用](#structured-api基本使用)
    - [一、创建DataFrame和Dataset](#一创建dataframe和dataset)
    ...
    - [二、Columns列操作](#二columns列操作)
        - [2.1 引用列](#21-引用列)
        - [2.2 新增列](#22-新增列)
        - [2.3 删除列](#23-删除列)
        - [2.4 重命名列](#24-重命名列)
    - [三、使用Structured API进行基本查询](#三使用structured-api进行基本查询)
    - [四、使用Spark SQL进行基本查询](#四使用spark-sql进行基本查询)
...
<div align="center"> <img src="../../pic/spark-sql-shell.png"/> </div>
