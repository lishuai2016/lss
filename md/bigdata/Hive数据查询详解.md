...
- [Hive数据查询详解](#hive数据查询详解)
    ...
    - [二、单表查询](#二单表查询)
        ...
        - [2.2 WHERE](#22-where)
        - [2.3  DISTINCT](#23--distinct)
        - [2.4 分区查询](#24-分区查询)
        - [2.5 LIMIT](#25-limit)
        - [2.6 GROUP BY](#26-group-by)
        - [2.7 ORDER AND SORT](#27-order-and-sort)
        - [2.8 HAVING](#28-having)
        - [2.9 DISTRIBUTE BY](#29-distribute-by)
        - [2.10 CLUSTER BY](#210-cluster-by)
    - [三、多表联结查询](#三多表联结查询)
        ...
        - [3.6 JOIN](#36-join)
    - [四、JOIN优化](#四join优化)
        - [4.1 STREAMTABLE](#41-streamtable)
        - [4.2 MAPJOIN](#42-mapjoin)
    - [五、SELECT的其他用途](#五select的其他用途)
    - [六、本地模式](#六本地模式)
    - [参考资料](#参考资料)
...
<div align="center"> <img width="600px"  src="../../pic/sql-join.jpg"/> </div>
...
<div align="center"> <img width="700px"   src="../../pic/hive-right-join.png"/> </div>
### 3.4 FULL OUTER  JOIN 
