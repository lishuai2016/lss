...
- [Zookeeper简介及核心概念](#zookeeper简介及核心概念)
    - [一、Zookeeper简介](#一zookeeper简介)
    - [二、Zookeeper设计目标](#二zookeeper设计目标)
        - [2.1 目标一：简单的数据模型](#21-目标一简单的数据模型)
        - [2.2 目标二：构建集群](#22-目标二构建集群)
        - [2.3 目标三：顺序访问](#23-目标三顺序访问)
        - [2.4 目标四：高性能高可用](#24-目标四高性能高可用)
    - [三、核心概念](#三核心概念)
        - [3.1 集群角色](#31-集群角色)
        - [3.2 会话](#32-会话)
        - [3.3 数据节点](#33-数据节点)
        ...
        - [3.6 ACL](#36-acl)
    - [四、ZAB协议](#四zab协议)
        - [4.1 ZAB协议与数据一致性](#41-zab协议与数据一致性)
        - [4.2  ZAB协议的内容](#42--zab协议的内容)
            - [1. 崩溃恢复](#1-崩溃恢复)
            - [2. 消息广播](#2-消息广播)
    - [五、Zookeeper的典型应用场景](#五zookeeper的典型应用场景)
        - [5.1数据的发布/订阅](#51数据的发布订阅)
        - [5.2 命名服务](#52-命名服务)
        - [5.3 Master选举](#53-master选举)
        - [5.4 分布式锁](#54-分布式锁)
        - [5.5 集群管理](#55-集群管理)
    - [参考资料](#参考资料)
...
<div align="center"> <img  src="../../pic/zookeeper-zknamespace.jpg"/> </div>

### 2.2 目标二：构建集群

可以由一组 Zookeeper 服务构成 Zookeeper 集群，集群中每台机器都会单独在内存中维护自身的状态，并且每台机器之间都保持着通讯，只要集群中有半数机器能够正常工作，那么整个集群就可以正常提供服务。

<div align="center"> <img  src="../../pic/zookeeper-zkservice.jpg"/> </div>
...
<div align="center"> <img  src="../../pic/zookeeper-zkcomponents.jpg"/> </div>
...
<div align="center"> <img  src="../../pic/zookeeper-brocast.jpg"/> </div>
