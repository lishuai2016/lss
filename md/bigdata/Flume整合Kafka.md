...
- [Flume 整合 Kafka](#flume-整合-kafka)
    - [一、背景](#一背景)
    - [二、整合流程](#二整合流程)
        - [1. 启动Zookeeper和Kafka](#1-启动zookeeper和kafka)
        - [2. 创建主题](#2-创建主题)
        - [3. 启动kafka消费者](#3-启动kafka消费者)
        - [4. 配置Flume](#4-配置flume)
        - [5. 启动Flume](#5-启动flume)
        - [6. 测试](#6-测试)
...
<div align="center"> <img  src="../../pic/flume-kafka.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-kafka-01.png"/> </div>

可以看到 `flume-kafka` 主题的消费端已经收到了对应的消息：

<div align="center"> <img  src="../../pic/flume-kafka-2.png"/> </div>
