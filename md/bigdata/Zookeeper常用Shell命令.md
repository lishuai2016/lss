...
- [Zookeeper常用Shell命令](#zookeeper常用shell命令)
    - [一、节点增删改查](#一节点增删改查)
        - [1.1 启动服务和连接服务](#11-启动服务和连接服务)
        - [1.2 help命令](#12-help命令)
        - [1.3 查看节点列表](#13-查看节点列表)
        - [1.4 新增节点](#14-新增节点)
        - [1.5 查看节点](#15-查看节点)
            - [1. 获取节点数据](#1-获取节点数据)
            - [2. 查看节点状态](#2-查看节点状态)
        ...
        - [1.7 删除节点](#17-删除节点)
    - [二、监听器](#二监听器)
        - [2.1 get path [watch]](#21-get-path-watch)
        - [2.2 stat path [watch]](#22-stat-path-watch)
        - [2.3 ls\ls2 path  [watch]](#23-ls\ls2-path--watch)
    - [三、 zookeeper 四字命令](#三-zookeeper-四字命令)
