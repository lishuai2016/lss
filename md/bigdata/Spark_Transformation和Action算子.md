...
- [Transformation 和 Action 常用算子](#transformation-和-action-常用算子)
    - [一、Transformation](#一transformation)
        - [1.1 map](#11-map)
        - [1.2 filter](#12-filter)
        - [1.3 flatMap](#13-flatmap)
        - [1.4 mapPartitions](#14-mappartitions)
        - [1.5 mapPartitionsWithIndex](#15-mappartitionswithindex)
        - [1.6 sample](#16-sample)
        - [1.7 union](#17-union)
        - [1.8 intersection](#18-intersection)
        - [1.9 distinct](#19-distinct)
        - [1.10 groupByKey](#110-groupbykey)
        - [1.11 reduceByKey](#111-reducebykey)
        - [1.12 sortBy & sortByKey](#112-sortby--sortbykey)
        - [1.13 join](#113-join)
        - [1.14 cogroup](#114-cogroup)
        - [1.15 cartesian](#115-cartesian)
        - [1.16 aggregateByKey](#116-aggregatebykey)
    - [二、Action](#二action)
        - [2.1 reduce](#21-reduce)
        - [2.2 takeOrdered](#22-takeordered)
        - [2.3 countByKey](#23-countbykey)
        - [2.4 saveAsTextFile](#24-saveastextfile)
    - [参考资料](#参考资料)
...
<div align="center"> <img src="../../pic/spark-aggregateByKey.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-getpartnum.png"/> </div>
