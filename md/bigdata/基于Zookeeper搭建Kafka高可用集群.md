...
- [基于Zookeeper搭建Kafka高可用集群](#基于zookeeper搭建kafka高可用集群)
    - [一、Zookeeper集群搭建](#一zookeeper集群搭建)
        - [1.1 下载 & 解压](#11-下载--解压)
        - [1.2 修改配置](#12-修改配置)
        - [1.3 标识节点](#13-标识节点)
        - [1.4 启动集群](#14-启动集群)
        - [1.5 集群验证](#15-集群验证)
    - [二、Kafka集群搭建](#二kafka集群搭建)
        - [2.1 下载解压](#21-下载解压)
        - [2.2 拷贝配置文件](#22-拷贝配置文件)
        - [2.3 修改配置](#23-修改配置)
        - [2.4 启动集群](#24-启动集群)
        - [2.5 创建测试主题](#25-创建测试主题)
...
zookeeper02 配置，与 zookeeper01 相比，只有 `dataDir` 和 `dataLogDir` 不同：
...
zookeeper03 配置，与 zookeeper01，02 相比，也只有 `dataDir` 和 `dataLogDir` 不同：
...
<div align="center"> <img  src="../../pic/zookeeper-cluster.png"/> </div>
...
<div align="center"> <img src="../../pic/kafka-cluster-shell.png"/> </div>
