...
- [Spark SQL 外部数据源](#spark-sql-外部数据源)
    - [一、简介](#一简介)
        - [1.1 多数据源支持](#11-多数据源支持)
        - [1.2 读数据格式](#12-读数据格式)
        - [1.3 写数据格式](#13-写数据格式)
    - [二、CSV](#二csv)
        - [2.1 读取CSV文件](#21-读取csv文件)
        - [2.2 写入CSV文件](#22-写入csv文件)
        - [2.3 可选配置](#23-可选配置)
    - [三、JSON](#三json)
        - [3.1 读取JSON文件](#31-读取json文件)
        - [3.2 写入JSON文件](#32-写入json文件)
        - [3.3 可选配置](#33-可选配置)
    - [四、Parquet](#四parquet)
        - [4.1 读取Parquet文件](#41-读取parquet文件)
        - [2.2 写入Parquet文件](#22-写入parquet文件)
        - [2.3 可选配置](#23-可选配置-1)
    - [五、ORC](#五orc)
        - [5.1 读取ORC文件](#51-读取orc文件)
        - [4.2 写入ORC文件](#42-写入orc文件)
    - [六、SQL Databases](#六sql-databases)
        - [6.1 读取数据](#61-读取数据)
        - [6.2 写入数据](#62-写入数据)
    - [七、Text](#七text)
        - [7.1 读取Text数据](#71-读取text数据)
        - [7.2 写入Text数据](#72-写入text数据)
    - [八、数据读写高级特性](#八数据读写高级特性)
        - [8.1 并行读](#81-并行读)
        - [8.2 并行写](#82-并行写)
        - [8.3 分区写入](#83-分区写入)
        - [8.3 分桶写入](#83-分桶写入)
        - [8.5 文件大小管理](#85-文件大小管理)
    - [九、可选配置附录](#九可选配置附录)
        - [9.1 CSV读写可选配置](#91-csv读写可选配置)
        - [9.2 JSON读写可选配置](#92-json读写可选配置)
        - [9.3 数据库读写可选配置](#93-数据库读写可选配置)
    - [参考资料](#参考资料)
...
<div align="center"> <img src="../../pic/spark-mysql-分区上下限.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-分区.png"/> </div>
