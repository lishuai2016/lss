...
- [Spark Streaming与流处理](#spark-streaming与流处理)
    - [一、流处理](#一流处理)
        - [1.1 静态数据处理](#11-静态数据处理)
        - [1.2 流处理](#12-流处理)
    - [二、Spark Streaming](#二spark-streaming)
        - [2.1 简介](#21-简介)
        - [2.2 DStream](#22-dstream)
        - [2.3 Spark & Storm & Flink](#23-spark--storm--flink)
    - [参考资料](#参考资料)
...
<div align="center"> <img  src="../../pic/01_data_at_rest_infrastructure.png"/> </div>
...
<div align="center"> <img  src="../../pic/02_stream_processing_infrastructure.png"/> </div>
...
<div align="center"> <img width="600px" src="../../pic/spark-streaming-arch.png"/> </div>
...
<div align="center"> <img width="600px"   src="../../pic/spark-streaming-flow.png"/> </div>
