...
- [Hadoop分布式文件系统——HDFS](#hadoop分布式文件系统hdfs)
    - [一、介绍](#一介绍)
    - [二、HDFS 设计原理](#二hdfs-设计原理)
        - [2.1 HDFS 架构](#21-hdfs-架构)
        - [2.2 文件系统命名空间](#22-文件系统命名空间)
        - [2.3 数据复制](#23-数据复制)
        - [2.4 数据复制的实现原理](#24-数据复制的实现原理)
        - [2.5  副本的选择](#25--副本的选择)
        - [2.6 架构的稳定性](#26-架构的稳定性)
            - [1. 心跳机制和重新复制](#1-心跳机制和重新复制)
            - [2. 数据的完整性](#2-数据的完整性)
            - [3.元数据的磁盘故障](#3元数据的磁盘故障)
            - [4.支持快照](#4支持快照)
    - [三、HDFS 的特点](#三hdfs-的特点)
        - [3.1 高容错](#31-高容错)
        - [3.2 高吞吐量](#32-高吞吐量)
        - [3.3  大文件支持](#33--大文件支持)
        - [3.3 简单一致性模型](#33-简单一致性模型)
        - [3.4 跨平台移植性](#34-跨平台移植性)
...
![](../../pic/2020-01-27-10-33-36.png)

![](../../pic/2020-01-27-10-33-55.png)

![](../../pic/2020-01-27-10-34-23.png)



### 2. HDFS读数据原理

![](../../pic/2020-01-27-10-37-00.png)

思考：这里通过保证各个block块的完整性进而保证了原始文件的完整性？



### 3. HDFS故障类型和其检测方法

![](../../pic/2020-01-27-10-44-10.png)

![](../../pic/2020-01-27-10-44-29.png)



**第二部分：读写故障的处理**

![](../../pic/2020-01-27-10-47-07.png)



**第三部分：DataNode 故障处理**

![](../../pic/2020-01-27-10-49-22.png)



**副本布局策略**：

![](../../pic/2020-01-27-10-49-46.png)
