...
- [Spark Streaming 基本操作](#spark-streaming-基本操作)
    - [一、案例引入](#一案例引入)
        - [3.1 StreamingContext](#31-streamingcontext)
        - [3.2 数据源](#32-数据源)
        - [3.3 服务的启动与停止](#33-服务的启动与停止)
    - [二、Transformation](#二transformation)
        - [2.1 DStream与RDDs](#21-dstream与rdds)
        - [2.2 updateStateByKey](#22-updatestatebykey)
        - [2.3 启动测试](#23-启动测试)
    - [三、输出操作](#三输出操作)
        - [3.1 输出API](#31-输出api)
        - [3.1 foreachRDD](#31-foreachrdd)
        - [3.3 代码说明](#33-代码说明)
        - [3.4 启动测试](#34-启动测试)
    - [参考资料](#参考资料)
...
<div align="center"> <img  src="../../pic/spark-streaming-word-count-v1.png"/> </div>
<br/>
...
> 关于高级数据源的整合单独整理至：[Spark Streaming 整合 Flume](./Spark_Streaming整合Flume.md) 和 [Spark Streaming 整合 Kafka](./Spark_Streaming整合Kafka.md)
...
<div align="center"> <img  src="../../pic/spark-streaming-dstream-ops.png"/> </div>
...
<div align="center"> <img  src="../../pic/spark-streaming-word-count-v2.png"/> </div>
...
<div align="center"> <img  src="../../pic/spark-streaming-word-count-v3.png"/> </div>  
<br/>
