...
- [Hive CLI和Beeline命令行的基本使用](#hive-cli和beeline命令行的基本使用)
    - [一、Hive CLI](#一hive-cli)
        - [1.1 Help](#11-help)
        - [1.2 交互式命令行](#12-交互式命令行)
        - [1.3 执行SQL命令](#13-执行sql命令)
        - [1.4 执行SQL脚本](#14-执行sql脚本)
        - [1.5 配置Hive变量](#15-配置hive变量)
        - [1.6 配置文件启动](#16-配置文件启动)
        - [1.7 用户自定义变量](#17-用户自定义变量)
    - [二、Beeline](#二beeline)
        - [2.1 HiveServer2](#21-hiveserver2)
        - [2.1 Beeline](#21-beeline)
        - [2.3 常用参数](#23-常用参数)
    - [三、Hive配置](#三hive配置)
        - [3.1 配置文件](#31-配置文件)
        - [3.2 hiveconf](#32-hiveconf)
        - [3.3 set](#33-set)
        - [3.4 配置优先级](#34-配置优先级)
        - [3.5 配置参数](#35-配置参数)
    - [参考资料](#参考资料)
...
<div align="center"> <img width='700px' src="../../pic/hive-e.png"/> </div>
...
<div align="center"> <img width='700px' src="../../pic/hive-n-j.png"/> </div>
