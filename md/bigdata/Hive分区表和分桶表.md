...
- [Hive分区表和分桶表](#hive分区表和分桶表)
    - [一、分区表](#一分区表)
        - [1.1 概念](#11-概念)
        - [1.2 使用场景](#12-使用场景)
        - [1.3 创建分区表](#13-创建分区表)
        - [1.4 加载数据到分区表](#14-加载数据到分区表)
        - [1.5 查看分区目录](#15-查看分区目录)
    - [二、分桶表](#二分桶表)
        - [1.1 简介](#11-简介)
        - [1.2 理解分桶表](#12-理解分桶表)
        - [1.3 创建分桶表](#13-创建分桶表)
        - [1.4 加载数据到分桶表](#14-加载数据到分桶表)
            - [1. 设置强制分桶](#1-设置强制分桶)
            - [2. CTAS导入数据](#2-ctas导入数据)
        - [1.5 查看分桶文件](#15-查看分桶文件)
    - [三、分区表和分桶表结合使用](#三分区表和分桶表结合使用)
    - [参考资料](#参考资料)
...
<div align="center"> <img  src="../../pic/hive-hadoop-partitation.png"/> </div>
...
<div align="center"> <img width="600px"  src="../../pic/HashMap-HashTable.png"/> </div>
...
<div align="center"> <img  src="../../pic/hive-hadoop-mapreducer.png"/> </div>

### 1.5 查看分桶文件

bucket(桶) 本质上就是表目录下的具体文件：

<div align="center"> <img  src="../../pic/hive-hadoop-bucket.png"/> </div>
