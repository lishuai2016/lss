...
- [Azkaban Flow 1.0 的使用](#azkaban-flow-10-的使用)
    - [一、简介](#一简介)
    - [二、基本任务调度](#二基本任务调度)
        - [2.1 新建项目](#21-新建项目)
        - [2.2 任务配置](#22-任务配置)
    ...
    - [三、多任务调度](#三多任务调度)
        ...
        - [3.3 依赖关系](#33-依赖关系)
        - [3.4 执行结果](#34-执行结果)
    - [四、调度HDFS作业](#四调度hdfs作业)
    - [五、调度MR作业](#五调度mr作业)
    - [六、调度Hive作业](#六调度hive作业)
    - [七、在线修改作业配置](#七在线修改作业配置)
    - [附：可能出现的问题](#附可能出现的问题)
...
<div align="center"> <img  src="../../pic/azkaban-create-project.png"/> </div>
...
<div align="center"> <img  src="../../pic/azkaban-zip.png"/> </div>

通过 Web UI 界面上传：

<div align="center"> <img  src="../../pic/azkaban-upload.png"/> </div>

上传成功后可以看到对应的 Flows：

<div align="center"> <img  src="../../pic/azkaban-flows.png"/> </div>

### 2.4 执行任务

点击页面上的 `Execute Flow` 执行任务：

<div align="center"> <img  src="../../pic/azkaban-execute.png"/> </div>

### 2.5 执行结果

点击 `detail` 可以查看到任务的执行日志：

<div align="center"> <img  src="../../pic/azkaban-successed.png"/> </div>

<div align="center"> <img  src="../../pic/azkaban-log.png"/> </div>
...
<div align="center"> <img  src="../../pic/azkaban-task-abcde-zip.png"/> </div>

### 3.3 依赖关系

多个任务存在依赖时，默认采用最后一个任务的文件名作为 Flow 的名称，其依赖关系如图：

<div align="center"> <img  src="../../pic/azkaban-dependencies.png"/> </div>

### 3.4 执行结果

<div align="center"> <img  src="../../pic/azkaban-task-abcde.png"/> </div>
...
<div align="center"> <img  src="../../pic/azkaban-hdfs.png"/> </div>
...
<div align="center"> <img  src="../../pic/azkaban-mr.png"/> </div>
...
<div align="center"> <img  src="../../pic/azkaban-hive.png"/> </div>

执行结果如下：

<div align="center"> <img  src="../../pic/azkaban-hive-result.png"/> </div>

## 七、在线修改作业配置

在测试时，我们可能需要频繁修改配置，如果每次修改都要重新打包上传，这会比较麻烦。所以 Azkaban 支持配置的在线修改，点击需要修改的 Flow，就可以进入详情页面：

<div align="center"> <img  src="../../pic/azkaban-project-edit.png"/> </div>

在详情页面点击 `Eidt` 按钮可以进入编辑页面：

<div align="center"> <img  src="../../pic/azkaban-edit.png"/> </div>

在编辑页面可以新增配置或者修改配置：

<div align="center"> <img  src="../../pic/azkaban-click-edit.png"/> </div>
...
<div align="center"> <img  src="../../pic/azkaban-memory.png"/> </div>
