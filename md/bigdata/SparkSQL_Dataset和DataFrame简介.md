...
- [DataFrame和Dataset简介](#dataframe和dataset简介)
    - [一、Spark SQL简介](#一spark-sql简介)
    - [二、DataFrame & DataSet](#二dataframe--dataset)
        - [2.1 DataFrame](#21-dataframe)
        - [2.2 DataFrame 对比 RDDs](#22-dataframe-对比-rdds)
        - [2.3 DataSet](#23-dataset)
        - [2.4 静态类型与运行时类型安全](#24-静态类型与运行时类型安全)
        - [2.5 Untyped & Typed](#25-untyped--typed)
    - [三、DataFrame & DataSet  & RDDs 总结](#三dataframe--dataset---rdds-总结)
    - [四、Spark SQL的运行原理](#四spark-sql的运行原理)
        - [4.1 逻辑计划(Logical Plan)](#41-逻辑计划logical-plan)
        - [4.2 物理计划(Physical Plan)](#42-物理计划physical-plan)
        - [4.3 执行](#43-执行)
    - [参考资料](#参考资料)
...
<div align="center"> <img src="../../pic/sql-hive-arch.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-dataFrame+RDDs.png"/> </div>
...
<div align="center"> <img width="600px" src="../../pic/spark-unifed.png"/> </div>
...
<div align="center"> <img  width="600px"  src="../../pic/spark-运行安全.png"/> </div>

上面的描述可能并没有那么直观，下面的给出一个 IDEA 中代码编译的示例：

<div align="center"> <img src="../../pic/spark-运行时类型安全.png"/> </div>
...
<div align="center"> <img  width="600px"  src="../../pic/spark-structure-api.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-Logical-Planning.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-Physical-Planning.png"/> </div>
