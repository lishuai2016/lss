...
- [Flume 简介及基本使用](#flume-简介及基本使用)
    - [一、Flume简介](#一flume简介)
    - [二、Flume架构和基本概念](#二flume架构和基本概念)
        - [2.1 基本架构](#21-基本架构)
        - [2.2 基本概念](#22-基本概念)
        - [2.3 组件种类](#23-组件种类)
    - [三、Flume架构模式](#三flume架构模式)
        - [3.1 multi-agent flow](#31-multi-agent-flow)
        - [3.2 Consolidation](#32-consolidation)
        - [3.3 Multiplexing the flow](#33-multiplexing-the-flow)
    - [四、Flume配置格式](#四flume配置格式)
    - [五、Flume的安装部署](#五flume的安装部署)
    - [六、Flume使用案例](#六flume使用案例)
        - [6.1 案例一](#61-案例一)
            - [1. 配置](#1-配置)
            - [2. 启动](#2-启动)
            - [3. 测试](#3-测试)
        - [6.2 案例二](#62-案例二)
            ...
            - [3. 测试](#3-测试-1)
        - [6.3 案例三](#63-案例三)
            - [1. 配置日志收集Flume](#1-配置日志收集flume)
            - [2. 配置日志聚合Flume](#2-配置日志聚合flume)
            - [3. 启动](#3-启动)
            - [4.测试](#4测试)
...
<div align="center"> <img  src="../../pic/flume-architecture.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-multi-agent-flow.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-consolidation.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-multiplexing-the-flow.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-example-1.png"/> </div>

控制台的显示：

<div align="center"> <img  src="../../pic/flume-example-2.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-example-3.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-example-4.png"/> </div>
...
<div align="center"> <img  src="../../pic/flume-example-8.png"/> </div>

可以看到已经从 8888 端口监听到内容，并成功输出到控制台：

<div align="center"> <img  src="../../pic/flume-example-9.png"/> </div>
