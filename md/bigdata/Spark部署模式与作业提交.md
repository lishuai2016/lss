...
- [Spark部署模式与作业提交](#spark部署模式与作业提交)
    - [一、作业提交](#一作业提交)
        - [1.1  spark-submit](#11--spark-submit)
        - [1.2 deploy-mode](#12-deploy-mode)
        - [1.3 master-url](#13-master-url)
    - [二、Local模式](#二local模式)
    - [三、Standalone模式](#三standalone模式)
        - [3.1 环境配置](#31-环境配置)
        - [3.2 集群配置](#32-集群配置)
        - [3.3 启动](#33-启动)
        - [3.4 提交作业](#34-提交作业)
        - [3.5 可选配置](#35-可选配置)
    - [三、Spark on Yarn模式](#三spark-on-yarn模式)
        - [3.1 配置](#31-配置)
        - [3.2 启动](#32-启动)
        - [3.3 提交应用](#33-提交应用)
...
<div align="center"> <img src="../../pic/spark-pi.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-Standalone-web-ui.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-内存不足2.png"/> </div>
...
<div align="center"> <img src="../../pic/spark-内存不足.png"/> </div>   
