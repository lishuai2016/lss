...
- [弹性式数据集RDDs](#弹性式数据集rdds)
    - [一、RDD简介](#一rdd简介)
    - [二、创建RDD](#二创建rdd)
        - [2.1 由现有集合创建](#21-由现有集合创建)
        - [2.2 引用外部存储系统中的数据集](#22-引用外部存储系统中的数据集)
        - [2.3 textFile & wholeTextFiles](#23-textfile--wholetextfiles)
    - [三、操作RDD](#三操作rdd)
    - [四、缓存RDD](#四缓存rdd)
        - [4.1 缓存级别](#41-缓存级别)
        - [4.2 使用缓存](#42-使用缓存)
        - [4.3 移除缓存](#43-移除缓存)
    - [五、理解shuffle](#五理解shuffle)
        - [5.1 shuffle介绍](#51-shuffle介绍)
        - [5.2 Shuffle的影响](#52-shuffle的影响)
        - [5.3 导致Shuffle的操作](#53-导致shuffle的操作)
    - [五、宽依赖和窄依赖](#五宽依赖和窄依赖)
    - [六、DAG的生成](#六dag的生成)
    - [参考资料](#参考资料)
...
<div align="center"> <img src="../../pic/scala-分区数.png"/> </div>
...
<div align="center"> <img width="600px" src="../../pic/spark-reducebykey.png"/> </div>
...
<div align="center"> <img width="600px" src="../../pic/spark-窄依赖和宽依赖.png"/> </div>
...
<div align="center"> <img width="600px" height="600px" src="../../pic/spark-DAG.png"/> </div>
