...
- [5、AQS 在 CountDownLatch 的应用总结](#5aqs-在-countdownlatch-的应用总结)
    - [1、CountDownLatch 的三种典型用法](#1countdownlatch-的三种典型用法)
    - [2、CountDownLatch 的使用示例](#2countdownlatch-的使用示例)
    - [3、CountDownLatch 的不足](#3countdownlatch-的不足)
    - [4、CountDownLatch相常见面试题：](#4countdownlatch相常见面试题)

<!-- /TOC -->

> AQS 在CountDownLatch 等类中的应用原理是什么？
