...
- [1、源码分析](#1源码分析)
    - [1、多构造方法](#1多构造方法)
    - [2、equals() 比较两个字符串是否相等](#2equals-比较两个字符串是否相等)
    - [3、compareTo() 比较两个字符串](#3compareto-比较两个字符串)
    - [4、其他重要方法](#4其他重要方法)
- [2、== 和 equals 的区别](#2-和 equals 的区别)
- [3、final 修饰的好处](#3final 修饰的好处)
- [4、String 和 StringBuilder、StringBuffer 的区别](#4string-和 stringbuilderstringbuffer 的区别)
    - [5、String 和 JVM](#5string 和 jvm)
...
    // 用于存储字符串的值 final修饰，并且没有其他方法可以改变value数组的值，因此具有不变性
...
![](../../pic/2020-06-25/2020-06-25-14-52-12.png)
...
- 2、而 new String() 的方式一定会先在堆上创建一个字符串对象，然后再去常量池中查询此字符串的值是否已经存在，如果不存在会先在常量池中创建此字符串，然后把引用的值指向此字符串，如下代码所示：
...
![](../../pic/2020-06-25/2020-06-25-14-55-29.png)
