...
- [1、源码环境准备](#1源码环境准备)
- [2、endpoint](#2endpoint)
    - [1、init 过程分析](#1init-过程分析)
        - [1.AbstractProtocol # init](#1abstractprotocol--init)
        - [2.AbstractEndpoint # init](#2abstractendpoint--init)
        - [3.NioEndpoint # bind](#3nioendpoint--bind)
    - [2、start 过程分析](#2start-过程分析)
        - [1、AbstractProtocol # start](#1abstractprotocol--start)
        - [2、AbstractEndpoint # start](#2abstractendpoint--start)
        - [3、NioEndpoint # startInternal](#3nioendpoint--startinternal)
- [3、Acceptor](#3acceptor)
    - [1、Acceptor # run](#1acceptor--run)
    - [2、NioEndpoint # setSocketOptions](#2nioendpoint--setsocketoptions)
- [4、Poller](#4poller)
    - [1、Poller # run](#1poller--run)
    - [2、Poller # register](#2poller--register)
    - [3、PollerEvent # run](#3pollerevent--run)
- [5、processKey](#5processkey)
    - [1、Poller # processKey](#1poller--processkey)
    - [2、AbstractEndpoint # processSocket](#2abstractendpoint--processsocket)
    - [3、NioEndpoint # createSocketProcessor](#3nioendpoint--createsocketprocessor)
- [参考](#参考)
...
![](../../pic/2021-03-28/2021-03-28-13-46-02.png)
...
备注：本文基于 Tomcat 当前（2018-03-20）最新版本 9.0.6。
...
![](../../pic/2021-03-28/2021-03-28-13-59-20.png)
...
## 3、NioEndpoint # createSocketProcessor
