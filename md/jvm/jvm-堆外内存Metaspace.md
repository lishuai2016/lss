...
- [1、什么是 Metaspace](#1什么是-metaspace)
    - [1、什么时候分配 Metaspace 空间](#1什么时候分配-metaspace-空间)
    - [2、什么时候回收 Metaspace 空间](#2什么时候回收-metaspace-空间)
    - [3、内存通常会被保留](#3内存通常会被保留)
    - [4、配置 Metaspace 空间](#4配置-metaspace-空间)
    - [5、Metaspace 和 GC](#5metaspace-和-gc)
- [2、Metaspace 的架构](#2metaspace-的架构)
    - [1、最底层：the space list](#1最底层the-space-list)
- [参考](#参考)

<!-- /TOC -->

分代垃圾回收算法中，我们一直有一个永久代存在，叫 PermGen，内存上它是挨着堆的。为了垃圾回收方便，HotSpot 在永久代上一直是使用老年代的垃圾回收算法。
...
![](../../pic/2021-03-28/2021-03-28-22-08-41.png)
...
![](../../pic/2021-03-28/2021-03-28-22-10-13.png)
...
如果你发现有些地方看得不是很懂，希望你可以先对比一下 原文，如果是我的翻译问题，烦请告知。
